 ...
 * @author Lucas
 */
public class TelaListaApartamento extends javax.swing.JInternalFrame {

    /**
     * Creates new form ListaMoldelo
     */
    public TelaListaApartamento() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setIconifiable(true);
        setTitle("Tela Listar Apartamento");
    ...
    private void jBpdfActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBpdfActionPerformed
        ...
        try {
            ...
            Logger.getLogger(TelaListaApartamento.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void buscarModelo() {
        ...
        try {
            ...
            jTcpf.setText(modelo.getapnumero());
            jTnome.setText(modelo.getapnumero());
            jTtel.setText(modelo.getdispo());
            jCapartamento.getModel().setSelectedItem(modelo.getbloco());
    ...
    private void alterar() {
        ...
        mod.setapnumero(jTcpf.getText());
        mod.setapandar(jTnome.getText());
        mod.setdispo(jTtel.getText());

        Bloco fab = (Bloco) jCapartamento.getSelectedItem();
    ...
    private void exportarPDF() throws FileNotFoundException {
        ...
        ApartamentoDao m = new ApartamentoDao();
